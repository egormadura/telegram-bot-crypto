...
def start(message):
    ...
    bot.send_message(message.chat.id, text="Привет, {0.first_name}! Ну что, Погрузимся в криптовалютный мир 😉".format(message.from_user), reply_markup=markup)
...
def func(message):
    if message.text == "Новости 🗞":
        ...
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
        btn1 = types.KeyboardButton("CEFI")
        btn2 = types.KeyboardButton("DEFI")
        btn3 = types.InlineKeyboardButton("Выбрать другой раздел ◀", callback_data="other_section")
        markup.add(btn1, btn2, btn3)
        bot.send_message(message.chat.id,text="Выберите тип биржи", reply_markup=markup)    
            if message.text == "CEFI"
               markup = types.InlineKeyboardButton()
               btn1 = types.InlineKeyboardButton("Бинанс", url="https://etherscan.io/")
               btn2 = types.InlineKeyboardButton("Байбит", url="https://bscscan.com/")
               btn3 = types.InlineKeyboardButton("Выбрать другой раздел ◀", callback_data="other_section")
               markup.add(btn1, btn2, btn3)
               bot.send_message(message.chat.id,text="Выберите биржу", reply_markup=markup)    
            elif message.text == "DEFI"
               markup = types.InlineKeyboardButton()
               btn1 = types.InlineKeyboardButton("Юнисвоп", url="https://etherscan.io/")
               btn2 = types.InlineKeyboardButton("Панкейк", url="https://bscscan.com/")
               btn3 = types.InlineKeyboardButton("Выбрать другой раздел ◀", callback_data="other_section")
               markup.add(btn1, btn2, btn3)
               bot.send_message(message.chat.id,text="Выберите биржу", reply_markup=markup)    
